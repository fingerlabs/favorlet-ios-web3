WEB3CORE_VERSION ||= '3.0.7'

Pod::Spec.new do |spec|
    spec.name         = 'FavorletWeb3Swift'
    ...
    spec.source       = { :git => 'https://github.com/fingerlabs/favorlet-ios-web3.git', :tag => spec.version.to_s }
    ...
    spec.dependency 'FavorletWeb3Core', "~> #{WEB3CORE_VERSION}"
end
